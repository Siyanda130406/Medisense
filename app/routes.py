...
translations = {
    'zulu': {
        ...
        'Manage Time Slots': 'Phatha Izikhathi',
        ...
        'Reports': 'Imibiko',
        'System Reports': 'Imibiko Yesistimu',
        'Activity Log': 'Umlando Wemisebenzi',
        'Settings': 'Izilungiselelo',
        'System Settings': 'Izilungiselelo Zesistimu',
        'Terms Management': 'Ukuphathwa Kwemigomo',
        'Terms & Conditions Management': 'Ukuphathwa Kwemigomo Nezimo',
        'Terms and Conditions': 'Imigomo Nezimo',
        'Terms': 'Imigomo',
        'Accept Terms': 'Yamukela Imigomo',
        'Accept Terms & Conditions': 'Yamukela Imigomo Nezimo',
        'Login': 'Ngena',
        'Sign In': 'Ngena',
        'Sign Up': 'Bhalisa',
        'Sign out': 'Phuma',
        ...
        'Create Free Account': 'Dala I-akhawunti Yamahhala',
        'Create Account': 'Dala I-akhawunti',
        'Home': 'Ikhaya',
        'Back': 'Emuva',
        'Back to Dashboard': 'Buyela Ku-Dashboard',
        'Back to Login': 'Buyela Ekungeneni',
        'Back to Health & Symptoms': 'Buyela Ezimpilweni Nezimpawu',
        'Return to Dashboard': 'Buyela Ku-Dashboard',
        'Next': 'Okulandelayo',
        'Continue': 'Qhubeka',
        'Continue to Dashboard': 'Qhubeka Uye Ku-Dashboard',
        ...
        'Send Reset Code': 'Thumela Ikhodi Yokusetha Kabusha',
        'Send Reset Link': 'Thumela Isixhumanisi',
        'Set a new password': 'Faka iphasiwedi entsha',
        'Choose a strong password you\'ll remember.': 'Khetha iphasiwedi eqinile ozoyikhumbula.',
        'Full Name': 'Igama Eliphelele',
        'Name': 'Igama',
        'Phone': 'Ucingo',
        'Phone Number': 'Inombolo Yocingo',
        'Patient Phone': 'Ucingo Lwesiguli',
        'No phone': 'Akukho cingo',
        'Role': 'Indima',
        ...
        'Allergies': 'Ukungezwani Komzimbo',
        'Emergency Contact': 'Oxhumana Naye Esimeni Esiphuthumayo',
        'Emergency Contact Name': 'Igama Lomuntu Wokuxhumana Naye',
        'Emergency Contact Phone': 'Ucingo Lomuntu Wokuxhumana Naye',
        'Relationship': 'Ubudlelwane',
        'Spouse / Partner': 'Umyeni / Umlingani',
        'Parent': 'Umzali',
        'Child': 'Ingane',
        'Sibling': 'Umzalwane',
        'Friend': 'Umngane',
        'Basic Information': 'Ulwazi Oluyisisekelo',
        'Health Information': 'Ulwazi Lwezempilo',
        'Health Questionnaire': 'Imibuzo Yezempilo',
        'Complete Your Profile': 'Qedela I-Profile Yakho',
        'Complete Profile': 'Qedela I-Profile',
        'Update Profile': 'Buyekeza I-Profile',
        'My Health Profile': 'I-Profile Yami Yezempilo',
        'Profile Setup': 'Ukulungiselela I-Profile',
        ...
        'Nurse / Staff': 'Umhlengikazi / Umsebenzi',

        # ==================== APPOINTMENT ====================
        'Appointment': 'Ukubonisana',
        'Appointments': 'Izibonisano',
        'My Appointments': 'Izibonisano Zami',
        'Your Appointments': 'Izibonisano Zakho',
        'Appointment Date': 'Usuku Lokubonisana',
        'Appointment Time': 'Isikhathi Sokubonisana',
        ...
        'Status': 'Isimo',
        'Reason': 'Isizathu',
        'Reason for Visit': 'Isizathu Sokuvakasha',
        'Clinic': 'Umtholampilo',
        'Select Clinic': 'Khetha Umtholampilo',
        'Select a clinic': 'Khetha umtholampilo',
        'Select Your Clinic': 'Khetha Umtholampilo Wakho',
        'Clinic Name': 'Igama Lomtholampilo',
        'Clinic Address': 'Ikheli Lomtholampilo',
        'Clinic Location': 'Indawo Yomtholampilo',
        'Clinic ID': 'I-ID Yomtholampilo',
        'Scheduled': 'Kuhleliwe',
        ...
        'Today\'s Patients': 'Iziguli Zanamuhla',
        'Available': 'Iyatholakala',
        'Unavailable': 'Ayitholakali',
        'Booked': 'Kubhukiwe',
        'Walk-in': 'Ungene Ngaphandle Kokubhuka',
        'Walk-in appointment': 'Ukubonisana okungena ngaphandle kokubhuka',
        'No appointments found': 'Azikho izibonisano ezitholakele',
        'No appointments found.': 'Azikho izibonisano ezitholakele.',
        'No appointments scheduled for today.': 'Azikho izibonisano ezihleliwe zanamuhla.',
        'No recent activity': 'Akukho misebenzi yakamuva',
        'Book': 'Bhuka',
        'Booking': 'Ukubhuka',
        'Cancel': 'Khansela',
        'Cancel this appointment?': 'Khansela lesi sibonisano?',
        'Confirm Appointment': 'Qinisekisa Ukubonisana',
        'Appointment confirmed!': 'Ukubonisana kuqinisekisiwe!',
        'Reference': 'Inkomba',
        'You will receive an SMS reminder before your appointment.': 'Uzothola isikhumbuzi nge-SMS ngaphambi kokubonisana kwakho.',

        # ==================== RISK / URGENCY ====================
        'Risk': 'Ingozi',
        'Risk Level': 'Izinga Lengozi',
        'Risk Categories': 'Izigaba Zengozi',
        'Risk Category': 'Isigaba Sengozi',
        'Risk Assessment': 'Ukuhlola Ingozi',
        'No-Show Risk Assessment': 'Ukuhlola Ingozi Yokungaveli',
        'Low': 'Ephansi',
        'Medium': 'Emaphakathi',
        'Moderate': 'Emaphakathi',
        'High': 'Ephezulu',
        ...
        # ==================== HEALTH SCORE ====================
        'Health Score': 'Amaphuzu Ezempilo',
        'Excellent': 'Kuhle Kakhulu',
        'Good': 'Kuhle',
        'Fair': 'Kulingene',
        'Needs Attention': 'Kudinga Ukunakwa',
        'New': 'Okusha',
        'Score = profile completeness + appointments attended − no-shows': 'Amaphuzu = ukugcwala kwe-profile + izibonisano eziye zafika − abangavelanga',
        'New account — score starts at 0 and grows as you use MediSense': 'I-akhawunti entsha — amaphuzu aqala ku-0 futhi akhula njengoba usebenzisa i-MediSense',
        'Higher score = Higher risk of missing appointments': 'Amaphuzu aphezulu = Ingozi ephezulu yokungafiki ekuvakasheni',
        'Profile complete': 'I-profile igcwele',
        'ID number on file': 'Inombolo kamazisi igciniwe',
        'Emergency contact on file': 'Umuntu wokuxhumana naye ugciniwe',
        'Health conditions recorded': 'Izimo zempilo ziqoshiwe',
        'Allergies recorded': 'Ukungezwani komzimbo kuqoshiwe',
        ...
        'Add New Clinic': 'Faka Umtholampilo Omusha',
        'Remove': 'Susa',
        'Close': 'Vala',
        'Open': 'Vula',
        ...
        'I Understand & Agree': 'Ngiyaqonda Futhi Ngiyavuma',
        'Cancel & Logout': 'Khansela Futhi Uphume',
        'Decline & Sign Out': 'Nqaba Futhi Uphume',
        'Reset Password': 'Setha Kabusha Iphasiwedi',
        ...
        'Please fill in all fields': 'Sicela ugcwalise zonke izikhala',
        'Please fill in all required fields': 'Sicela ugcwalise zonke izikhala ezidingekayo',
        ...
        'Try: "Flu", "Paracetamol", "Chest pain", "Diabetes"': 'Zama: "Umkhuhlane", "Paracetamol", "Ubuhlungu besifuba", "Ushukela"',
        'Search diseases, symptoms, or medicines': 'Sesha izifo, izimpawu, noma imithi',
        'Search for diseases, symptoms, or medicines': 'Sesha izifo, izimpawu, noma imithi',
        'Search for diseases, symptoms, or medicines...': 'Sesha izifo, izimpawu, noma imithi...',
        ...
        'Symptoms': 'Izimpawu',
        'Symptom': 'Isimpawu',
        'Symptom Information': 'Ulwazi Lwesimpawu',
        'Symptom Descriptions': 'Izincazelo Zezimpawu',
        'Related Symptoms': 'Izimpawu Ezihlobene',
        'Disease': 'Isifo',
        'Diseases': 'Izifo',
        'Condition': 'Isimo',
        'Conditions': 'Izimo',
        'Disease Information': 'Ulwazi Ngesifo',
        'Treatment': 'Ukwelashwa',
        'Treatments': 'Izindlela Zokwelapha',
        'Recommended Treatments': 'Izindlela Zokwelapha Ezinconywayo',
        ...
        'Medicine': 'Umuthi',
        'Medicines': 'Imithi',
        'Medicines that treat': 'Imithi elapha',
        'Diseases treated by': 'Izifo ezelashwa ngu',
        'medicines found': 'imithi etholakele',
        'diseases found': 'izifo ezitholakele',
        'Hospital': 'Isibhedlela',
        'Health Tips': 'Amacebiso Ezempilo',
        'Health Tip': 'Icebiso Lezempilo',
        'Featured Diseases': 'Izifo Ezivelele',
        'Trending Topics': 'Izihloko Ezidumile',
        'Found': 'Kutholakele',
        'Found information for': 'Ulwazi olutholakele nge',
        'No results': 'Ayikho imiphumela',
        'Common Symptoms': 'Izimpawu Ezijwayelekile',
        'More': 'Okunye',
        'View': 'Buka',
        ...
        'Anaphylaxis emergency response': 'Indlela yokusabela ekungezwani komzimbo okukhulu',
        ...
        'If conscious, give water to drink': 'Uma eqaphile, mnike amanzi okuphuza',
        ...
        'Watch for allergic reaction': 'Qaphela ukungezwani komzimbo',
        ...
        'Apply cold compress to nose bridge': 'Faka i-compress ebandayo esiqondeni sekhala',
        ...
        'Live Dashboard - Real-time updates': 'I-Dashboard Ebukhoma - Izibuyekezo Zesikhathi Sangempela',
        ...
        'Total Appointments': 'Ingqikithi Yezibonisano',
        ...
        'showing': 'kuboniswa',
        'Distribution': 'Ukusatshalaliswa',
        'Last 7 days': 'Izinsuku ezi-7 ezedlule',
        'No recent users': 'Abekho abasebenzisi bakamuva',
        'No users found': 'Abekho abasebenzisi abatholakele',
        'No clinics found. Click "Add New Clinic" to create one.': 'Awekho amatholampilo atholakele. Chofoza "Faka Umtholampilo Omusha" ukuze udale elinye.',
        'No staff members found.': 'Awekho abasebenzi abatholakele.',
        'No activity recorded yet.': 'Akukho misebenzi eqoshiwe okwamanje.',
        'No-Show Rate': 'Izinga Lokungaveli',
        'Daily Appointments (Last 7 Days)': 'Izibonisano Zansuku Zonke (Izinsuku ezi-7 ezedlule)',
        'System name cannot be changed.': 'Igama lesistimu alinakushintshwa.',
        'System Version': 'Inguqulo Yesistimu',
        'Default Language': 'Ulimi Olusetshenziswa Njalo',
        'Select the default language for the system.': 'Khetha ulimi olusetshenziswa njalo esistimini.',
        'Appointment Reminder (Hours before)': 'Isikhumbuzi Sokubonisana (Amahora ngaphambili)',
        'How many hours before an appointment to send reminders.': 'Mangaki amahora ngaphambi kokubonisana okufanele kuthunyelwe isikhumbuzi.',
        'Maximum Appointments per Day': 'Inani Eliphezulu Lezibonisano Ngosuku',
        'Maximum number of appointments allowed per day per clinic.': 'Inani eliphezulu lezibonisano ezivunyelwe ngosuku ngomtholampilo ngamunye.',

        # Admin user management
        'Edit User': 'Hlela Umsebenzisi',
        'User updated successfully!': 'Umsebenzisi uye wabuyekezwa ngempumelelo!',
        'User created successfully!': 'Umsebenzisi uye wadalwa ngempumelelo!',
        'User deleted successfully.': 'Umsebenzisi uye wasuswa ngempumelelo.',
        'User status updated.': 'Isimo somsebenzisi sibuyekezwe.',
        'User not found.': 'Umsebenzisi akatholakalanga.',
        'Email already registered.': 'I-imeyili isivele ibhalisiwe.',
        'Email already registered': 'I-imeyili isivele ibhalisiwe',
        'Password must be at least 6 characters.': 'Iphasiwedi kufanele ibe nezinhlamvu eziyisithupha okungenani.',
        'Password must be at least 6 characters': 'Iphasiwedi kufanele ibe nezinhlamvu eziyisithupha okungenani',
        'All fields are required.': 'Zonke izikhala ziyadingeka.',
        'You cannot delete your own account.': 'Awukwazi ukususa i-akhawunti yakho.',
        'Toggle user status?': 'Shintsha isimo somsebenzisi?',
        'Delete this user? This action cannot be undone.': 'Susa lo msebenzisi? Lesi senzo asikwazi ukubuyiselwa.',
        'Delete this clinic? This action cannot be undone.': 'Susa lo mtholampilo? Lesi senzo asikwazi ukubuyiselwa.',
        'Email cannot be changed': 'I-imeyili ayinakushintshwa',
        'cannot be changed': 'ayinakushintshwa',
        'Enter full name': 'Faka igama eliphelele',
        'Enter email': 'Faka i-imeyili',
        'Enter password': 'Faka iphasiwedi',
        'Enter staff code': 'Faka ikhodi yabasebenzi',
        'Enter phone': 'Faka ucingo',
        'e.g., 0821234567': 'isb., 0821234567',
        'Patient Name': 'Igama Lesiguli',
        'Enter patient\'s full name': 'Faka igama eliphelele lesiguli',
        'Enter patient\'s phone number': 'Faka inombolo yocingo yesiguli',
        'Your assigned clinic is selected by default': 'Umtholampilo wakho owabelweyo ukhethwa ngokuzenzakalela',
        'Select time': 'Khetha isikhathi',
        'Select date': 'Khetha usuku',

        # Admin clinic management
        'Clinic Management': 'Ukuphathwa Kwemitholampilo',
        'Add, edit, and delete clinics in the system.': 'Engeza, hlela, futhi ususe imitholampilo esitimini.',
        'Enter the details of the new clinic to add to the system.': 'Faka imininingwane yomtholampilo omusha ukuze wengezwe esitimini.',
        'e.g., Soweto Community Clinic': 'isb., Umtholampilo Womphakathi waseSoweto',
        'Enter the full name of the clinic': 'Faka igama eliphelele lomtholampilo',
        'e.g., Johannesburg, Durban, Cape Town': 'isb., Johannesburg, Durban, Cape Town',
        'The city where the clinic is located': 'Idolobha lapho umtholampilo ukhona',
        'e.g., Soweto, Umlazi, Khayelitsha': 'isb., Soweto, Umlazi, Khayelitsha',
        'Specific area or suburb within the city': 'Indawo ethile noma isigodi edolobheni',
        'Area': 'Indawo',
        'City': 'Idolobha',
        'Province': 'Isifundazwe',
        'Select Province': 'Khetha Isifundazwe',
        'Services Offered': 'Izinsizakalo Ezinikezwayo',
        'List the services provided by the clinic': 'Bhala izinsizakalo ezinikezwa umtholampilo',
        'e.g., General Consultation, HIV/TB Testing, Immunizations': 'isb., Ukubonisana Okujwayelekile, Ukuhlolwa kwe-HIV/TB, Imigomo',
        'Contact number for the clinic': 'Inombolo yokuxhumana yomtholampilo',
        'e.g., 035 123 4567': 'isb., 035 123 4567',
        'Update the details of the clinic.': 'Buyekeza imininingwane yomtholampilo.',

        # ==================== STAFF ====================
        'Staff Dashboard': 'I-Dashboard Yabasebenzi',
        'Manage your appointments and patients.': 'Phatha izibonisano zakho neziguli.',
        'Book an appointment for a walk-in patient': 'Bhukela isiguli esingenile ngaphandle kokubhuka',
        'Choose the clinic you are working at today.': 'Khetha umtholampilo osebenza kuwo namuhla.',
        'You will only see patients from this clinic': 'Uzobona kuphela iziguli ezivela kulo mtholampilo',
        'Please select your clinic first': 'Sicela ukhethe umtholampilo wakho kuqala',
        'Please select your clinic first.': 'Sicela ukhethe umtholampilo wakho kuqala.',
        'Your clinic': 'Umtholampilo wakho',
        'Your assigned clinic is selected by default': 'Umtholampilo wakho owabelweyo ukhethwa ngokuzenzakalela',
        'Clinic Name': 'Igama Lomtholampilo',
        'Search Patients': 'Sesha Iziguli',
        'Search for a patient': 'Sesha isiguli',
        'Search by name, phone, or email': 'Sesha ngegama, ucingo, noma i-imeyili',
        'Enter a name, phone number, or email to find them.': 'Faka igama, inombolo yocingo, noma i-imeyili ukuze ubathole.',
        'No patients found for': 'Awekho iziguli ezitholakele zokuthi',
        'Export Data': 'Khipha Idatha',
        'Manage Slots': 'Phatha Izikhathi',
        'Manage Time Slots': 'Phatha Izikhathi',
        'Time': 'Isikhathi',
        ...
        'Action': 'Isenzo',
        'Actions': 'Izenzo',
        'Mark No-Show': 'Phawula Njengokungaveli',
        'Mark this patient as No-Show?': 'Phawula lesi siguli njengokungavelanga?',
        'Checked-in': 'Ungene',
        'Make Available': 'Yenza Itholakale',
        'Block': 'Vimba',
        'Time slot': 'Isikhathi',
        'marked as unavailable': 'kumakwe njengokungatholakali',
        'is now available': 'manje iyatholakala',
        'Today': 'Namuhla',
        'View': 'Buka',

        # ==================== PATIENT NO-SHOW ====================
        'No-Show History': 'Umlando Wokungaveli',
        'Total No-Shows': 'Ingqikithi Yokungaveli',
        'Total Appointments': 'Ingqikithi Yezibonisano',
        'No-Show Rate': 'Izinga Lokungaveli',
        'Great news! You have no no-show appointments. Keep up the good work!': 'Izindaba ezinhle! Awunazo izibonisano ongazifikanga. Qhubeka nomsebenzi omuhle!',
        'Booked On': 'Kubhukwe Ngo',
        ...
        'Skip to main content': 'Yeqela kokuqukethwe okuyinhloko',
        ...
        'Distance': 'Ibanga',
        'Please update your location': 'Sicela ubuyekeze indawo yakho',

        # ==================== HEALTH CHATBOT ====================
        'Health Chatbot': 'I-Chatbot Yezempilo',
        'Ask any health question in plain language. Answers come from our medical Q&A database.': 'Buza noma yimuphi umbuzo wezempilo ngolimi olulula. Izimpendulo zivela kudathabhethi yethu ye-Q&A yezokwelapha.',
        'Recent questions': 'Imibuzo yakamuva',
        'You asked': 'Ubuze',
        'Searched for': 'Kuseshiwe',
        'No answer found. Try rephrasing, or use the Health Search page.': 'Ayikho impendulo etholakele. Zama ukuphinda usho, noma sebenzisa ikhasi Lokusesha Kwezempilo.',
        'Answers are for general information only. Always consult a healthcare professional.': 'Izimpendulo ziwulwazi olujwayelekile kuphela. Hlala ubonana nochwepheshe bezempilo.',

        # ==================== PUBLIC PAGES ====================
        'Free Symptom Check': 'Ukuhlolwa Kwezimpawu Mahhala',
        'Describe how you feel — no login needed. Sign up to save results and book appointments.': 'Chaza ukuthi uzizwa kanjani — akukho kungenwa okudingekayo. Bhalisa ukuze ugcine imiphumela futhi ubhuke izibonisano.',
        'No sign-up needed to try basic features.': 'Akukho kubhalisa okudingekayo ukuzama izici eziyisisekelo.',
        'Create a free account': 'Dala i-akhawunti yamahhala',
        'Create a free account to book appointments, track symptoms, and more.': 'Dala i-akhawunti yamahhala ukubhuka izibonisano, ukulandelela izimpawu, nokunye.',
        'Create a free account to book appointments, save health history, and get personalized recommendations.': 'Dala i-akhawunti yamahhala ukubhuka izibonisano, ukugcina umlando wezempilo, nokuthola izincomo eziqondene nawe.',
        'Sign up free': 'Bhalisa mahhala',
        'to book appointments at these clinics.': 'ukuze ubhuke izibonisano kule mitholampilo.',
        'Healthcare, in your pocket.': 'Ezempilo, ephaketheni lakho.',
        'MediSense helps South Africans understand symptoms, find clinics, book appointments, and get first aid — in English and isiZulu.': 'I-MediSense isiza abantu baseNingizimu Afrika ukuba baqonde izimpawu, bathole imitholampilo, babhuke izibonisano, bathole usizo lokuqala — ngesiNgisi nangesiZulu.',
        'Check Symptoms': 'Hlola Izimpawu',
        'Sign In': 'Ngena',
        'Symptom Check': 'Ukuhlolwa Kwezimpawu',
        'Find Clinics': 'Thola Imitholampilo',
        'First Aid': 'Usizo Lokuqala',
        'Symptom Checker': 'Isihloli Sezimpawu',
        'Medicine Search': 'Ukusesha Imithi',
        'What MediSense does': 'Okwenziwa yi-MediSense',
        'Describe how you feel in plain language. Get possible conditions, urgency, and next steps.': 'Chaza ukuthi uzizwa kanjani ngolimi olulula. Thola izimo ezingaba khona, ukuphuthuma, nezinyathelo ezilandelayo.',
        'Search medicines by disease, or find what a medicine treats — two-way search.': 'Sesha imithi ngesifo, noma uthole ukuthi umuthi welapha ini — ukusesha kabili.',
        'Search by province, city, or area. Get directions in Google Maps.': 'Sesha ngesifundazwe, idolobha, noma indawo. Thola iziqondiso ku-Google Maps.',
        'Real-time slots. No double bookings. Automatic no-show detection.': 'Izikhathi zesikhathi sangempela. Akukho kubhuka kabili. Ukutholwa kokungaveli okuzenzakalelayo.',
        'Step-by-step instructions for 20+ emergencies: heart attack, stroke, choking, and more.': 'Imiyalo yesinyathelo ngesinyathelo yezimo eziphuthumayo ezingaphezu kuka-20: ukuhlaselwa inhliziyo, ukushaywa umgogodla, ukuminywa, nokunye.',
        'Sign in and ask health questions in plain language. Get answers from our medical Q&A database.': 'Ngena futhi ubuze imibuzo yezempilo ngolimi olulula. Thola izimpendulo kudathabhethi yethu ye-Q&A yezokwelapha.',
        'English & isiZulu': 'IsiNgisi nesiZulu',
        'The full interface works in both languages. Switch any time from the navbar.': 'Isixhumanisi esigcwele sisebenza kuzo zombili izilimi. Shintsha noma nini kusuka kunavbar.',
        'Works on any phone': 'Isebenza kunoma yiluphi ucingo',
        'Smartphone, feature phone, or USSD. No internet needed for USSD bookings.': 'I-Smartphone, ifoni ejwayelekile, noma i-USSD. Akukho inthanethi edingekayo ekubhukeni nge-USSD.',
        'Ready to take charge of your health?': 'Ukulungele ukuthatha umthwalo wezempilo yakho?',
        'Clinics across South Africa': 'Imitholampilo kulo lonke elaseNingizimu Afrika',
        'Diseases in our database': 'Izifo kudathabhethi yethu',
        'Medicines catalogued': 'Imithi ebhalisiwe',
        'Try MediSense without an account:': 'Zama i-MediSense ngaphandle kwe-akhawunti:',
        'Enter your location above to find clinics near you.': 'Faka indawo yakho ngenhla ukuze uthole imitholampilo eseduze nawe.',
        'Search 500+ real South African clinics — no login needed.': 'Sesha imitholampilo engaphezu kuka-500 yaseNingizimu Afrika yangempela — akukho kungenwa okudingekayo.',
        'Step-by-step emergency instructions — free, no login needed.': 'Imiyalo yesimo esiphuthumayo yesinyathelo ngesinyathelo — mahhala, akukho kungenwa okudingekayo.',
        'Sign up free for full access including symptom search, appointment booking, and health journal.': 'Bhalisa mahhala ukuze uthole ukufinyelela okugcwele kufaka phakathi ukusesha izimpawu, ukubhuka izibonisano, nejenali yezempilo.',
        'Want more?': 'Ufuna okunye?',
        ...
        'Please enter your full name.': 'Sicela ufake igama lakho eliphelele.',
        'Please enter your age': 'Sicela ufake iminyaka yakho',
        'Please enter a valid age (1-120)': 'Sicela ufake iminyaka evumelekile (1-120)',
        'Please enter a valid age': 'Sicela ufake iminyaka evumelekile',
        'Please enter your location': 'Sicela ufake indawo yakho',
        'Please select your gender.': 'Sicela ukhethe ubulili bakho.',
        'Please select your gender': 'Sicela ukhethe ubulili bakho',
        'Staff code required for nurse/admin': 'Ikhodi yabasebenzi iyadingeka kumhlengikazi/umlawuli',
        'Staff code required for nurse/admin accounts.': 'Ikhodi yabasebenzi iyadingeka kuma-akhawunti omhlengikazi/umlawuli.',
        'You must agree to the Terms and Conditions.': 'Kufanele uvume Imigomo Nezimo.',
        'You must agree to the Terms and Conditions to continue.': 'Kufanele uvume Imigomo Nezimo ukuze uqhubeke.',
        'Please enter a valid 10-digit phone number starting with 0 (e.g., 0821234567)': 'Sicela ufake inombolo yocingo evumelekile enamadijithi ayi-10 eqala ngo-0 (isb., 0821234567)',
        'Please login first.': 'Sicela ungene kuqala.',
        'Please sign in to continue.': 'Sicela ungene ukuze uqhubeke.',
        'Please accept the Terms and Conditions to continue.': 'Sicela wamukele Imigomo Nezimo ukuze uqhubeke.',
        'Admin access required.': 'Ukufinyelela komlawuli kuyadingeka.',
        'You do not have access to that page.': 'Awunakho ukufinyelela kulolo khasi.',
        'Account created! Please complete your profile.': 'I-akhawunti idaliwe! Sicela uqedele i-profile yakho.',
        'Profile already set up': 'I-profile isivele ilungisiwe',
        'Profile setup complete! Welcome to MediSense.': 'Ukulungiselela i-profile kuqedile! Siyakwamukela ku-MediSense.',
        'Profile updated successfully': 'I-profile ibuyekezwe ngempumelelo',
        'Please complete your profile first.': 'Sicela uqedele i-profile yakho kuqala.',
        'Please select your clinic first.': 'Sicela ukhethe umtholampilo wakho kuqala.',
        'Welcome back': 'Siyakwamukela',
        'Logged out': 'Uphumile',
        'You have been signed out.': 'Uphumile.',
        'Invalid credentials': 'Ulwazi lokungena olungavumelekile',
        'Invalid email or password.': 'I-imeyili noma iphasiwedi engavumelekile.',
        'Account inactive': 'I-akhawunti ayisebenzi',
        'Account inactive. Contact support.': 'I-akhawunti ayisebenzi. Xhumana nokusekelwa.',
        'Account created!': 'I-akhawunti idaliwe!',
        'Email already registered': 'I-imeyili isivele ibhalisiwe',
        'Please fill in all fields': 'Sicela ugcwalise zonke izikhala',
        'Please fill in all fields.': 'Sicela ugcwalise zonke izikhala.',
        'Invalid or expired reset link.': 'Isixhumanisi sokusetha kabusha asivumelekile noma siphelelwe isikhathi.',
        'Invalid or expired reset link. Please request a new one.': 'Isixhumanisi sokusetha kabusha asivumelekile noma siphelelwe isikhathi. Sicela ucele esisha.',
        'No account found with that email address.': 'Ayikho i-akhawunti etholakele ngalelo kheli le-imeyili.',
        'Password reset successful! You can now login with your new password.': 'Ukusetha kabusha iphasiwedi kuphumelele! Manje ungakwazi ukungena ngephasiwedi yakho entsha.',
        'Password reset successfully. Please sign in.': 'Iphasiwedi isethwe kabusha ngempumelelo. Sicela ungene.',
        'Password reset link sent to': 'Isixhumanisi sokusetha kabusha iphasiwedi sithunyelwe ku',
        'Please check your inbox.': 'Sicela uhlole ibhokisi lakho lokungenayo.',
        'Failed to send email. Please try again later.': 'Yehlulekile ukuthumela i-imeyili. Sicela uzame futhi kamuva.',
        'Could not send email. Please try again later.': 'Ayikwazanga ukuthumela i-imeyili. Sicela uzame futhi kamuva.',

        # ==================== TIME / STATUS ====================
        'Checked-in': 'Ungene',
        'Waiting': 'Uyalinda',
        'Cancel this appointment?': 'Khansela lesi sibonisano?',
        'Appointment cancelled': 'Ukubonisana kukhanseliwe',
        'Appointment cancelled.': 'Ukubonisana kukhanseliwe.',
        'Reminder sent': 'Isikhumbuzi sithunyelwe',
        'Reminder sent.': 'Isikhumbuzi sithunyelwe.',
        'No-shows marked': 'Abangavelanga baphawuliwe',
        'Settings saved successfully!': 'Izilungiselelo zigcinwe ngempumelelo!',
        'Settings saved.': 'Izilungiselelo zigciniwe.',
        'Clinic added successfully!': 'Umtholampilo wengezwe ngempumelelo!',
        'Clinic updated successfully!': 'Umtholampilo ubuyekezwe ngempumelelo!',
        'Clinic deleted successfully.': 'Umtholampilo ususiwe ngempumelelo.',
        'Clinic not found.': 'Umtholampilo awutholakalanga.',
        'Staff member verified successfully.': 'Ilungu labasebenzi liqinisekisiwe ngempumelelo.',
        'Terms accepted successfully!': 'Imigomo yamukelwe ngempumelelo!',
        'Terms accepted. Welcome to MediSense!': 'Imigomo yamukelwe. Siyakwamukela ku-MediSense!',
        'Terms not available. Please contact support.': 'Imigomo ayitholakali. Sicela uxhumane nokusekelwa.',
        'Symptom recorded in your health journal.': 'Isimpawu siqoshiwe kujenali yakho yezempilo.',
        'Symptom recorded.': 'Isimpawu siqoshiwe.',
        'No results found for your question': 'Ayikho imiphumela etholakele yombuzo wakho',
        'No results found for': 'Ayikho imiphumela etholakele ye',
        'No information found for': 'Akukho lwazi olutholakele lwe',
        'No exact match found for': 'Akukho okufana ncamashi okutholakele kwe',
        'Showing results for': 'Kuboniswa imiphumela ye',
        'No results for': 'Ayikho imiphumela ye',
        'Did you mean': 'Ngabe usho',
        'Would you like to try': 'Ungathanda ukuzama',
        'Try': 'Zama',

        # ==================== ADMIN TERMS ====================
        'Current Terms': 'Imigomo Yamanje',
        'Update Terms': 'Buyekeza Imigomo',
        'Version': 'Inguqulo',
        'Effective': 'Kusebenza Kusukela',
        'Effective Date': 'Usuku Lokusebenza',
        'Terms Content (HTML)': 'Okuqukethwe Kwemigomo (HTML)',
        'Version History': 'Umlando Wenguqulo',
        'Archived': 'Kugciniwe',
        'Version number must be unique and increasing.': 'Inombolo yenguqulo kufanele ihluke futhi ikhule.',
        'Use HTML for formatting (h5, p, ul, li, strong, etc.)': 'Sebenzisa i-HTML ukufometha (h5, p, ul, li, strong, njll.)',
        'Updating terms will require all users to re-accept.': 'Ukubuyekeza imigomo kuzodinga ukuthi bonke abasebenzisi baphinde bamukele.',

        # ==================== AGE / DATE / MISC ====================
        'Age must be between 1 and 120.': 'Iminyaka kufanele ibe phakathi kuka-1 no-120.',
        'ID number is required.': 'Inombolo kamazisi iyadingeka.',
        'ID number must contain only digits.': 'Inombolo kamazisi kufanele ibe namadijithi kuphela.',
        'ID Number:': 'Inombolo Kamazisi:',
        'The ID number you entered contains an invalid month.': 'Inombolo kamazisi oyifakile iqukethe inyanga engavumelekile.',
        'The ID number you entered contains an invalid day.': 'Inombolo kamazisi oyifakile iqukethe usuku olungavumelekile.',
        'Please enter a valid 13-digit South African ID number.': 'Sicela ufake inombolo kamazisi yaseNingizimu Afrika evumelekile enamadijithi ayi-13.',
        '13-digit South African ID number': 'Inombolo kamazisi yaseNingizimu Afrika enamadijithi ayi-13',
        'e.g., 9001011234567': 'isb., 9001011234567',
        'e.g., Durban, Cape Town, Soweto': 'isb., Durban, Cape Town, Soweto',
        'e.g., Durban, Soweto, Empangeni': 'isb., Durban, Soweto, Empangeni',
        'e.g., Durban, Cape Town, Soweto, KwaMashu': 'isb., Durban, Cape Town, Soweto, KwaMashu',
        'e.g., Diabetes, Hypertension, Asthma (separate with commas)': 'isb., Ushukela, Umfutho Wegazi Ophakeme, Isifuba (hlukanisa ngamakhoma)',
        'List any health conditions you have, separated by commas.': 'Bhala noma yiziphi izimo zempilo onazo, zihlukaniswe ngamakhoma.',
        'List any health conditions you have (e.g., Diabetes, Hypertension, Asthma) - separate with commas': 'Bhala noma yiziphi izimo zempilo onazo (isb., Ushukela, Umfutho Wegazi Ophakeme, Isifuba) - hlukanisa ngamakhoma',
        'This helps us provide better health recommendations': 'Lokhu kusisiza sinikeze izincomo ezingcono zezempilo',
        'This helps us find clinics near you': 'Lokhu kusisiza sithole imitholampilo eseduze nawe',
        'This helps us provide personalized health recommendations': 'Lokhu kusisiza sinikeze izincomo zezempilo eziqondene nawe',
        'Your health information is kept confidential and secure.': 'Ulwazi lwakho lwezempilo lugcinwa luyimfihlo futhi luphephile.',
        'Your health information is kept confidential and only used to support your care.': 'Ulwazi lwakho lwezempilo lugcinwa luyimfihlo futhi lusetshenziselwa kuphela ukusekela ukunakekelwa kwakho.',
        'Your personal and health information will be kept confidential and used only for appointment management and healthcare services.': 'Ulwazi lwakho lomuntu siqu nolwezempilo luzogcinwa luyimfihlo futhi lusetshenziselwe kuphela ukuphathwa kwezibonisano nezinsizakalo zezempilo.',
        'Your health, our priority. Manage your appointments and health information here.': 'Impilo yakho, kuqala kithi. Phatha izibonisano zakho nolwazi lwezempilo lapha.',
        'This information will only be used in case of emergency': 'Lolu lwazi luzosetshenziswa kuphela esimweni esiphuthumayo',
        'Please list your allergies': 'Sicela ubhale ukungezwani komzimbo kwakho',
        'e.g., Penicillin, Peanuts': 'isb., i-Penicillin, amantongomane',
        'e.g., Penicillin (rash), Peanuts (swelling), Latex': 'isb., i-Penicillin (ukuqubuka), amantongomane (ukuvuvukala), i-Latex',
        'Include the allergen and the reaction if you know it. This is shared with nurses and staff for your safety.': 'Faka into engakwenza ukungezwani kanye nokusabela uma ukwazi. Lokhu kwabelwana ngakho nomhlengikazi nabasebenzi ukuze uphephe.',
        'Do you have any known allergies?': 'Ngabe unakho ukungezwani komzimbo okwaziwayo?',
        'No known allergies': 'Akukho ukungezwani komzimbo okwaziwayo',
        'Yes — I have allergies': 'Yebo — nginakho ukungezwani komzimbo',
        'No': 'Cha',
        'Yes': 'Yebo',
        'No known allergies reported.': 'Akukho ukungezwani komzimbo okwaziwayo okubikiwe.',
        'Not provided.': 'Akunikeziwe.',
        'Optional but recommended for SMS reminders': 'Akudingekile kodwa kunconywa ezikhumbuzi ze-SMS',
        'Optional but recommended for SMS reminders.': 'Akudingekile kodwa kunconywa ezikhumbuzi ze-SMS.',
        'Required for nurse and admin accounts.': 'Iyadingeka kuma-akhawunti omhlengikazi nowomlawuli.',
        'Required for nurse and admin accounts. Contact your supervisor if you do not have one.': 'Iyadingeka kuma-akhawunti omhlengikazi nowomlawuli. Xhumana nomphathi wakho uma ungenayo.',
        'Required for Nurse/Staff and Admin roles.': 'Iyadingeka ezinhlakeni zomhlengikazi/umsebenzi nowomlawuli.',
        'Optional': 'Akudingekile',
        'Password must be at least 6 characters': 'Iphasiwedi kufanele ibe nezinhlamvu eziyisithupha okungenani',
        'Min 6 characters': 'Okungenani izinhlamvu eziyisithupha',
        'Enter your new password below.': 'Faka iphasiwedi yakho entsha ngezansi.',
        'Choose a strong password you\'ll remember.': 'Khetha iphasiwedi eqinile ozoyikhumbula.',
        ...
        'Already have an account?': 'Usuvele unayo i-akhawunti?',
        'Don\'t have an account?': 'Awunayo i-akhawunti?',
        'Create one': 'Dala eyodwa',
        'Sign in to your MediSense account': 'Ngena ku-akhawunti yakho ye-MediSense',
        'Free, secure, and takes less than a minute': 'Mahhala, kuphephile, futhi kuthatha ngaphansi komzuzu',
        'Name cannot be changed. Contact support for changes.': 'Igama alinakushintshwa. Xhumana nokusekelwa ukuze kushintshwe.',
        'I agree to the': 'Ngiyavuma',
        'I have read and agree to the Terms and Conditions': 'Ngifundile futhi ngiyavuma Imigomo Nezimo',
        'By using MediSense, you agree to comply with these Terms and Conditions.': 'Ngokusebenzisa i-MediSense, uyavuma ukuhambisana nale Migomo Nezimo.',
        'By creating an account, you agree to use MediSense for legitimate healthcare purposes only.': 'Ngokudala i-akhawunti, uyavuma ukusebenzisa i-MediSense ngezinjongo zezempilo ezisemthethweni kuphela.',
        'MediSense provides health information and appointment management only. It is NOT a substitute for professional medical advice, diagnosis, or treatment.': 'I-MediSense inikeza ulwazi lwezempilo nokuphathwa kwezibonisano kuphela. AKUYONA indawo yeseluleko sochwepheshe bezempilo, ukuxilongwa, noma ukwelashwa.',
        'Always consult a qualified healthcare provider for medical concerns.': 'Hlala ubonana nomhlinzeki wokunakekelwa kwezempilo oqeqeshiwe ngezinkinga zezempilo.',
        'By providing your phone number, you consent to receive SMS reminders about appointments.': 'Ngokunikeza inombolo yakho yocingo, uvuma ukuthola izikhumbuzi nge-SMS mayelana nezibonisano.',
        'You agree to arrive on time for appointments. Repeated no-shows may result in restricted access to booking services.': 'Uyavuma ukufika ngesikhathi ezibonisanweni. Ukungaveli okuphindaphindiwe kungaholela ekuncishisweni kokufinyelela ezinsizakalweni zokubhuka.',
        'Your personal and health information will be kept confidential and used only for healthcare services and appointment management.': 'Ulwazi lwakho lomuntu siqu nolwezempilo luzogcinwa luyimfihlo futhi lusetshenziselwe kuphela izinsizakalo zezempilo nokuphathwa kwezibonisano.',
        'You agree to use MediSense for legitimate healthcare purposes only. Any misuse or abuse will result in account termination.': 'Uyavuma ukusebenzisa i-MediSense ngezinjongo zezempilo ezisemthethweni kuphela. Noma yikuphi ukusetshenziswa kabi noma ukuhlukumeza kuzoholela ekuqedweni kwe-akhawunti.',
        'MediSense is not liable for any damages arising from the use of this platform. All healthcare decisions should be made with professional guidance.': 'I-MediSense ayinasibopho sanoma yimuphi umonakalo ovela ekusetshenzisweni kwale nkundla. Zonke izinqumo zezempilo kufanele zenziwe ngokuqondiswa kochwepheshe.',
        'MediSense reserves the right to update these terms. Continued use constitutes acceptance of updated terms.': 'I-MediSense inelungelo lokubuyekeza le migomo. Ukuqhubeka nokusetshenziswa kusho ukwamukela imigomo ebuyekeziwe.',
        'For questions, contact us at: support@medisense.com': 'Ngemibuzo, xhumana nathi ku: support@medisense.com',
        'User Accounts': 'Ama-akhawunti Abasebenzisi',
        'You must provide accurate information when creating an account. You are responsible for maintaining the confidentiality of your password.': 'Kufanele unikeze ulwazi olunembile lapho udala i-akhawunti. Unesibopho sokugcina iphasiwedi yakho iyimfihlo.',
        'Privacy Policy': 'Inqubomgomo Yobumfihlo',
        'SMS Notifications': 'Izaziso ze-SMS',
        'No-Show Policy': 'Inqubomgomo Yokungaveli',
        'Medical Disclaimer': 'Isitatimende Sokuzikhulisa Emthwalweni Wezempilo',
        'User Conduct': 'Ukuziphatha Komsebenzisi',
        'Liability': 'Isibopho',
        'Changes to Terms': 'Izinguquko Emigomeni',
        'Contact': 'Xhumana',
        'Acceptance of Terms': 'Ukwamukelwa Kwemigomo',
        'Appointment Booking': 'Ukubhukwa Kwezibonisano',
        'No-Show Policy': 'Inqubomgomo Yokungaveli',
        'By using MediSense, you agree to comply with these Terms and Conditions.': 'Ngokusebenzisa i-MediSense, uyavuma ukuhambisana nale Migomo Nezimo.',
    }
}
